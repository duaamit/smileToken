...
async function main() {
  ...
  const myKeypair = loadWalletKey(
    "mai5ebjUVodkLW2WWpRf6ApY8VrNn36RYHedxZ6ySyT.json"
  );
  console.log(myKeypair.publicKey.toBase58());
  const mint = new web3.PublicKey(
    "smiSLExhszT3GioQwFE9MWjRR2qnhWa9uST2h9VoRWn"
  );
  ...
  const dataV2 = {
    name: "smile Token",
    symbol: "$smile",
    uri: "https://gateway.pinata.cloud/ipfs/QmUT1wu2C4ps7B22YmLDhWPvqFcge41C8V4uNjvPmQtcHx",
    // we don't need that
